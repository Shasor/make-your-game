...
export class Animation extends System {
    ...
    update(deltaTime) {
        this.entities.forEach((entity) => {
            ...
            // Animations normales
            if (input && property) {
                console.log('isPushing:', property.isPushing); // Debug log
                console.log('Current input vector:', input.vector.h); // Debug log

                // Vérifier la condition de push en premier
                if (property.isPushing && input.vector.h !== 0) {
                    console.log('Setting push animation'); // Debug log
